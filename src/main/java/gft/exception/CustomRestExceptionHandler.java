...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler{ 
	...
	//TODA EXCEÇÃO QUE TIVER, O SPRING VAI PROCURAR ESSA CLASSE PRA RESOLVER OS ERROS
	
	@ExceptionHandler( {ApiDogException.class} )
	public ResponseEntity<ApiErrorDTO>handleLojaException(ApiDogException ex, WebRequest request){
